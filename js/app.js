...
alert('Hello ' + uName + '! Welcome to My Webpage, I hope you enjoy with it');
...
btn.addEventListener('click', () => {
  ...
  var favCountry = valText('Give me a name of country you think i want to visit');
  ...
  for (var i = 0; i < 6; i++) {
    ...
    if (j != 6) {
      ...
      if (i != 5) {
        favCountry = valText('Give me a name, This is your' + (i + 1) + 'try');
...
function valNumber(mess) {
  ...
  if (value) {
    ...
    alert("no please just enter a number");
    valNumber(mess);
  }
}

function valText(mess) {
